            ...
            <td className="px-6 py-4">
              <button
                ...
                className={`text-white ${
                  isReservado(reserva)
                    ? isReservado(reserva)
                      ? "bg-green-500 hover:bg-green-800 dark:bg-green-500 dark:hover:bg-green-800 dark:focus:ring-green-800"
                      : "bg-blue-700 hover:bg-blue-800 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-800"
                    : reserva.reservados === reserva.limiteReserva
                    ? "bg-gray-500 hover:bg-gray-800 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
                    : "bg-blue-700 hover:bg-blue-800"
                } hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2`}
              >
                Reservá
              </button>
            </td>
